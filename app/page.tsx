  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <section className="py-32 bg-gradient-to-br from-green-600 to-green-800 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto animate-on-scroll">
            ...
            <div className="relative mx-auto max-w-3xl animate-fade-in-up overflow-hidden rounded-2xl border-4 border-white/20 shadow-2xl delay-400">
              <iframe
                className="w-full aspect-video"
                src="https://www.youtube.com/embed/HvlP4iFJi6s"
                title="Découvrez notre approche transformationnelle"
                frameBorder="0"
      ...
      <section className="py-32 bg-gradient-to-r from-gray-900 to-gray-800 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/entreprise.jpg')] bg-cover bg-center opacity-10"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto animate-on-scroll">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 animate-fade-in-up">
